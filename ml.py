...
if __name__ == "__main__":
    grid_size = (10, 10)
    starts = [(0, 0), (1, 0), (8,1)]  # Starting positions for the bots
    ends = [(9, 2), (8, 9), (5,2)]     # Destination positions for the bots
    obstacles = [(2,2),(3, 3), (3, 4), (3, 5), (4, 5), (5, 5), (4,4), (6,6), (7,7), (8,8)]  # Obstacles in the grid
