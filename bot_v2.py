...
class WarehouseBotApp:
    ...
    def setup_controls(self):
        ...
        tk.Button(control_frame, text="Run Simulation", command=self.run_simulation).grid(row=1, column=0)
        tk.Button(control_frame, text="Clear Grid", command=self.clear_grid).grid(row=1, column=1)
        tk.Button(control_frame, text="Reset All", command=self.reset_all).grid(row=1, column=2)
